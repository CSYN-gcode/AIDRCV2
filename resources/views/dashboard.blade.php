                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <button type="button" class="btn btn-lg btn-info" id="btnFilterTable" title="Load Filtered Table"><i class="fa fa-retweet"></i> Filter Table</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <div class="input-group-text">
                                                    <input type="checkbox" id="check_filter_category">
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend w-50">
                                                <div class="input-group-text">
                                                    <input type="checkbox" id="check_filter_app_status">
                                                </div>
                                            ...
                                            <select class="form-control sel-status-list" id="filter_app_status" multiple name="filter_app_status[]" disabled>
                                                ...
                                                <option value="4">DCC Validated, For Approval</option>
                                                <option value="5">Disapproved</option>
                                                <option value="6">Cancelled</option>
                                                <option value="7">For DCC Control (For Edit)</option>
                                                <option value="8">For DCC Control (For Upload)</option>
                                                <option value="9">Document Controlled</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            dt_applications = $('#tbl_applications').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "load_aidrc_applications_table",
        ...
        $('#check_filter_category').change(function(e) {
            if($('#check_filter_category').is(':checked')){
                $('#hidden_check_category').val(1);
                $('#filter_category').removeAttr('disabled');
            }else{
                $('#hidden_check_category').val('');
                $('#filter_category').prop('disabled', 'disabled');
            }
        });

        $('#check_filter_app_status').change(function(e) {
            if($('#check_filter_app_status').is(':checked')){
                $('#hidden_check_app_status').val(1);
                $('#filter_app_status').removeAttr('disabled');
            }else{
                $('#hidden_check_app_status').val('');
                $('#filter_app_status').prop('disabled', 'disabled');
            }
        });
