                                        ...
                                        <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.2;text-align:left;color:#000000;">
                                            <h1 style="font-family: 'Cabin', sans-serif; text-align: center;">
                                              <span style="font-family: Arial, sans-serif; font-size: 18px;">Application for Approval</span>
                                            </h1>
                                          </div>
                                        </td>
                                      </tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                      <tr>
                                        <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
                                            <h3>
                                              <span style="font-family: Arial, sans-serif; font-size: 12px;">Hi, you have an application for approval! See details below:</span>
                                            </h3>
                                            <p>&nbsp;</p>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                  <td>
                                                    <span style="font-family: Arial, sans-serif;">
                                                      <strong>
                                                        <span style="font-size: 12px;">Originator Remarks</span>
                                                      </strong>
                                                    </span>
                                                  </td>
                                                  <td>

                                                    @if($application[0]->originator_remarks != null)

                                                    <span style="font-size: 12px; font-family: Arial, sans-serif;">{{ $application[0]->originator_remarks }}</span>
