          ...
          <div class="card card-primary">
            <div class="card-header">
               <div class="float-sm-right">
                <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalAddApplication" title="Add New AIDRC Application"><i class="fa fa-plus"></i> Add New Application</button>
              </div>
            </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
          ...
          <div class="col">
            <div class="input-group input-group-sm mb-3">
              <div class="input-group-prepend w-50">
                <span class="input-group-text w-100" id="basic-addon1">ATTACHMENT (only accepts .PDF Files)</span>
              </div>
                  ...
                  <div class="col">
                    <div class="input-group input-group-sm mb-3">
                      ...
                      <div class="input-group-prepend">
                         <button type="button" class="btn btn-sm btn-info btn-document-action" document-action="1" title="Add Document Details" id="btnAddDocumentDetails" data-toggle="modal" data-target="#modalSearchDocumentDetails" disabled><i class="fa fa-file"></i>&nbsp;<i class="fa fa-plus"></i></button>
                      </div>
          ...
          <div class="col">
            <div class="card card-primary">
              ...
              <div class="card-header">
                 ...
                 <p>(Optional): To be filled up by Process Owner/Originator if there are other documents which needs to be updated to match with the revised documents mentioned above. Will be approved by Selected Head.</p>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <div class="float-sm-right">
                      <button type="button" class="btn btn-sm btn-info btn-document-action" document-action="4" title="Add Document Details" data-toggle="modal" data-target="#modalSearchDocumentDetails"><i class="fa fa-plus-circle"></i> Add Affected Document</button>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <div class="input-group input-group-sm mb-3">
                      <div class="input-group-prepend w-50">
                        <span class="input-group-text w-100" id="basic-addon1">SECTION HEAD / APPROVER</span>
                      </div>
                      
                       <select class="form-control sel-rapidx-section-heads" id="add_section_head_approver" name="add_section_head_approver">
                        <option value="0" selected disabled>-- Select One --</option>
                      </select>
        ...
        <div class="row operation-approvers d-none">
          <div class="col">
            <div class="card card-primary">
              <div class="card-header">
                 <h5 class="card-title"><i class="fa fa-users"></i> <strong>Application Approvers</strong></h5>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <p><i class="fa fa-info-circle"></i> Select your Section Head by clicking one of the radio buttons below. They will be the first one to approve the application, followed by the others in any order.</p>                    
                  </div>
                </div>
      ...
      <div class="modal-footer">
         <button type="button" class="btn btn-sm btn-success" id="btnSubmitApplication"><i class="fa fa-upload"></i> Submit Application</button>
      </div>
  ...
  <div class="modal-dialog modal-xl-custom">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="input-group input-group-sm mb-3">
                            ...
                            <select class="form-control" id="qs_doc_category" name="qs_doc_category" disabled>
                              <option value="0" selected disabled>-- Select One --</option>
                              <option value="1">PGS</option>
                              <option value="2">PQS</option>
                              <option value="3">PPS</option>
          ...
          <div class="col-sm-8">
            ...
            <div class="row">
              <div class="col">
                <p><i class="fa fa-info-circle"></i> <strong>VALIDATION CHECK</strong>: To be filled by QS Staff. Press the action button per approver to include Validation Checkpoints (Can add multiple FMEA, Control Plan, Pre-Production Checksheet). <strong><i>Note: Even if there are no affected documents assigned, Eng'g, QC head will still review the application.</i></strong></p>
              </div>
            </div>
              ...
              <div class="row">
                 <div class="col">
                  <div class="float-sm-right">
                    <button type="button" class="btn btn-sm btn-info btn-document-action" document-action="2" title="Add Document Details" data-toggle="modal" data-target="#modalSearchDocumentDetails"><i class="fa fa-plus-circle"></i>Add QS Checkpoints</button>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-footer">
          ...
          <button type="button" class="btn btn-sm btn-danger mr-auto" id="btnQsDisapproveApplication"><i class="fa fa-times-circle"></i> Disapprove Application</button>

         <button type="button" class="btn btn-sm btn-success" id="btnQsApproveApplication"><i class="fa fa-check-circle"></i> Submit QS Validation</button>
      </div>
      </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="input-group input-group-sm mb-3">
                            ...
                            <select class="form-control" id="head_doc_category" name="head_doc_category" disabled>
                              <option value="0" selected disabled>-- Select One --</option>
                              <option value="1">PGS</option>
                              <option value="2">PQS</option>
                              <option value="3">PPS</option>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="input-group input-group-sm mb-3">
                            ...
                            <select class="form-control" id="head_doc_type" name="head_doc_type" disabled>
                              <option value="0" selected disabled>-- Select One --</option>
                              <option value="1">New Document</option>
                              <option value="2">Revised</option>
                            </select>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="input-group input-group-sm mb-3">
                            ...
                            <select class="form-control" id="head_for_group" name="head_for_group" disabled>
                              <option value="0" selected disabled>-- Select One --</option>
                              <option value="1">Operations</option>
                              <option value="2">Support Group</option>
                              <option value="3">Operations - PPC/Warehouse </option>
          ...
          <div class="col-sm-8">
            ...
            <div class="row">
              <div class="col">
                <p><i class="fa fa-info-circle"></i> <strong>APPLICATION REVIEW</strong>: Application for checking of selected head. All documents which are not disapproved will be considered "Approved" after the review.<i>(Note if for Operations: Once approved by the first approver set by the originator, other approvers can now review in any sequence.)</i></p>
              </div>
            </div>
            ...
            <div class="row">
                  <div class="col">
                    <div class="float-sm-right">
                      <button type="button" class="btn btn-sm btn-info btn-document-action" document-action="3" title="Add Document Details" data-toggle="modal" data-target="#modalSearchDocumentDetails"><i class="fa fa-plus-circle"></i> Add Affected Document</button>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col">
                <div class="input-group input-group-sm mb-3">
                  ...
                  <textarea class="form-control" id="head_approval_remarks" name="head_approval_remarks" rows="3" style="resize: none;" placeholder="(Required!)"></textarea>
        ...
        <div class="modal-footer">
           ...
           <button type="button" class="btn btn-sm btn-success" id="btnHeadApproveApplication"><i class="fa fa-check-circle"></i> Approve Application</button>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="col-sm-4">
            ...
            <div class="row">
              <div class="col">
                <p><i class="fa fa-info-circle"></i> <strong>INITIAL CONFIRMATION</strong>: To be filled-up by QAD-DCC</p>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col">
                   <div class="dt-responsive table-responsive">
                    <table id="tbl_dcc_affected_documents" class="table table-sm table-bordered table-striped table-hover" style="width: 100%; font-size: 85%;">
                      <caption>Affected Documents / Checkpoints for Approval</caption>
                      <thead>
                        <tr>
                          <th>Checkpoint</th>
              ...
              <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <select class="form-control" id="dcc_checkpoint_similar" name="dcc_checkpoint_similar">
               ...
               <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <select class="form-control" id="dcc_checkpoint_alignment" name="dcc_checkpoint_alignment">
                      <option selected disabled>-- Select One --</option>
                      <option value="1">COMPLIANT</option>
               ...
               <div class="row">
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <select class="form-control" id="dcc_checkpoint_standard" name="dcc_checkpoint_standard">
                      <option selected disabled>-- Select One --</option>
                      <option value="1">COMPLIANT</option>
                      <option value="2">NON-COMPLIANT</option>
                    </select>
                ...
                <div class="col">
                  <div class="input-group input-group-sm mb-3">
                    ...
                    <select class="form-control" id="dcc_validation_judgement" name="dcc_validation_judgement">
                      ...
                      <option value="2">FOR MINOR REVISIONS</option>
                      <option value="3">FOR MAJOR REVISIONS</option>
                    </select>
...
$('#btnDisapproveDocument').click(function(){
  ...
  if($('#edit_affected_approver_remarks').val() == '' || $('#edit_affected_approver_remarks').val() == null)
  {
