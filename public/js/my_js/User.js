...
function LoadRapidXUserListQSInspector(cboElement)
{
  let result = '<option value="">N/A</option>';

  $.ajax({

   url: "load_rapidx_user_list_qs_inspector",
   method: "get",
   dataType: "json",
   beforeSend: function(){
          result = '<option value=""> -- Loading -- </option>';
...
function LoadOriginatorList(cboElement)
{
  let result = '<option value="">N/A</option>';

  $.ajax({

   url: "load_originator_list",
   method: "get",
   dataType: "json",
   beforeSend: function(){
          result = '<option value=""> -- Loading -- </option>';
...
function LoadApproverList(cboElement)
{
  let result = '<option value="">N/A</option>';

  $.ajax({

   url: "load_approver_list",
   method: "get",
   dataType: "json",
   beforeSend: function(){
          result = '<option value=""> -- Loading -- </option>';
...
function LoadAffectedApproverList(cboElement)
{
  let result = '<option value="">N/A</option>';

  $.ajax({

   url: "load_affected_approver_list",
   method: "get",
   dataType: "json",
   beforeSend: function(){
          result = '<option value=""> -- Loading -- </option>';
...
function LoadPicList(cboElement)
{
  let result = '<option value="">N/A</option>';
...
function LoadQsInspectorList(cboElement)
{
  let result = '<option value="">N/A</option>';

  $.ajax({

   url: "load_qs_inspector_list",
   method: "get",
   dataType: "json",
   beforeSend: function(){
          result = '<option value=""> -- Loading -- </option>';
