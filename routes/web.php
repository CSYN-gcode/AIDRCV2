...
Route::post('/submit_external_application', 'NewApplicationController@submit_external_application');
...
Route::post('/new_cancel_application','NewApplicationController@new_cancel_application');
...
Route::get('/get_external_application_data','NewApplicationController@get_external_application_data');
Route::get('/download_external_application/{id}/{category}','NewApplicationController@download_external_application');
